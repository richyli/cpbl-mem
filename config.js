...
const CONFIG = {
  ...
  attributes: [
    ...
    },
    {
      ...
      // 3 水準；張數統一 4 張，純測順位高低（避免順位×張數兩變因混淆）
      levels: [
        { tag: "p4", label: "第四順位購票・每場 4 張" },
        { tag: "p3", label: "第三順位購票・每場 4 張" },
        { tag: "p2", label: "第二順位購票・每場 4 張" },
      ],
    },
    {
  ...
  scales: {
    ...
    value: {
      ...
      items: [
        ...
        "專屬活動或會員限定權益，會讓我覺得自己和一般球迷有所不同。",   // 社會
  ...
  demographics: [
    ...
    { key:"watch_broadcast", label:"平均每月看中職比賽轉播的場數", options:["幾乎不看","1–2 場","3–5 場","6 場以上"] },
    { key:"watch_stadium", label:"平均每月到球場看中職比賽的場數", options:["幾乎不看","1–2 場","3–5 場","6 場以上"] },
